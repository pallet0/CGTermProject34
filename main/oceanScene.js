...
export function createOceanScene({ renderer, camera, canvas, scene, stats }) {
  ...
  const skybox = cubetextureloader.load([
    'assets/ocean/TropicalSunnyDay_px.jpg', 'assets/ocean/TropicalSunnyDay_nx.jpg',
    'assets/ocean/TropicalSunnyDay_py.jpg', 'assets/ocean/TropicalSunnyDay_ny.jpg',
    'assets/ocean/TropicalSunnyDay_pz.jpg', 'assets/ocean/TropicalSunnyDay_nz.jpg',
  ]);
  ...
  textureLoader.load('ocean2.png', (tileTexture) => {
  ...
  class WaterSimulation {
    constructor() {
      ...
      const shadersPromises = [
        loadFileLocal('shaders/simulation/vertex.glsl'),
        loadFileLocal('shaders/simulation/drop_fragment.glsl'),
        loadFileLocal('shaders/simulation/update_fragment.glsl'),
      ];
  ...
  class Water {
    constructor() {
      ...
      const shadersPromises = [loadFileLocal('shaders/water/vertex.glsl'), loadFileLocal('shaders/water/fragment.glsl')];
  ...
  class EnvironmentMap {
    constructor() {
      ...
      const shaderProm = [loadFileLocal('shaders/environment_mapping/vertex.glsl'), loadFileLocal('shaders/environment_mapping/fragment.glsl')];
      this._meshes = [];
  ...
  class Caustics {
    constructor() {
      ...
      const prom = [loadFileLocal('shaders/caustics/water_vertex.glsl'), loadFileLocal('shaders/caustics/water_fragment.glsl')];
  ...
  class Environment {
    constructor() {
      const p = [loadFileLocal('shaders/environment/vertex.glsl'), loadFileLocal('shaders/environment/fragment.glsl')];
      this._meshes = [];
  ...
  class Debug {
    constructor() {
      ...
      const prom = [loadFileLocal('shaders/debug/vertex.glsl'), loadFileLocal('shaders/debug/fragment.glsl')];
